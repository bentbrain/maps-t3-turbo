...
function EmojiPickerEmoji({
  ...
  return (
    <button
      {...props}
      className={cn(
        "relative flex aspect-square size-8 items-center justify-center overflow-hidden rounded-md text-lg before:absolute before:inset-0 before:-z-1 before:hidden before:items-center before:justify-center before:text-[2.5em] before:blur-lg before:saturate-500 before:content-[attr(data-emoji)] data-[active]:bg-neutral-100/80 data-[active]:before:flex dark:data-[active]:bg-neutral-800/80",
        className,
      )}
